...
const EditStudyProgrammeModal = ({ isOpen, onClose, studyProgramme, onChange, onSubmit }) => {
        ...
        <div>
          ...
          <div>
            ...
            <Select
              id="subjectAreaId"
              name="subjectAreaId"
              value={studyProgramme.subjectAreaId._id}
              onChange={onChange}
              required
            >
...
export default EditStudyProgrammeModal;